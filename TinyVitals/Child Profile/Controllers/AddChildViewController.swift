...
//            byAdding: DateComponents(year: -selectedYears, month: -selectedMonths),
//            to: Date()
//        ) ?? Date()
//
//        let photoFilename = didPickAvatarImage
//            ? avatarImageView.image.flatMap(saveImageToDisk)
//            : saveImageToDisk(defaultAvatarForGender(gender))
//
...
//        print("🔥 SAVE BUTTON TAP VIA addTarget")
//    }
//
//    /*
//    // MARK: - Navigation
